                  ...
                  >
                    <div>
                      <button 
                        ...
                        class="flex items-center max-w-xs bg-white rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 p-0.5 hover:bg-gray-50"
                        id="user-menu-button" 
                        aria-expanded="false" 
                        aria-haspopup="true"
                      >
