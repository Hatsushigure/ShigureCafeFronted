                  ...
                  <BaseCard body-class="p-6">
                    <div class="space-y-4">
                      ...
                      <div>
                        ...
                        <textarea v-model="form.content" rows="15" class="appearance-none rounded-xl relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 font-mono focus:outline-none focus:border-indigo-500 sm:text-sm" placeholder="公告内容"></textarea>
                      </div>
